const imageUrl =
  'https://api.nasa.gov/mars-photos/api/v1/rovers/opportunity/photos?sol=1000&api_key=DjaT9ZuDgQSEzDCpSQuU9EsZYEPwdKZkxrAJR12B';
...
function addImages(photos) {
  ...
  const imageContainer = document.querySelector('.rover-header');
